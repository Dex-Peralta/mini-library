                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['students']); ?></p>
                            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['authors']); ?></p>
                            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['books']); ?></p>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['active_borrows']); ?></p>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
                        ...
                        <a href="<?php echo e(route('students.index')); ?>" class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition">
                        ...
                        <a href="<?php echo e(route('authors.index')); ?>" class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition">
                        ...
                        <a href="<?php echo e(route('books.index')); ?>" class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition">
                        ...
                        <a href="<?php echo e(route('borrows.create')); ?>" class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg hover:border-orange-500 hover:bg-orange-50 transition">
                        ...
                        <a href="<?php echo e(route('returns.manage')); ?>" class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg hover:border-red-500 hover:bg-red-50 transition">
                        ...
                        <a href="<?php echo e(route('borrows.index')); ?>" class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg hover:border-indigo-500 hover:bg-indigo-50 transition">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_copies']); ?></p>
                            <p class="text-sm text-gray-600">Total Copies</p>
                        </div>
                        <div class="text-center p-4 bg-green-50 rounded-lg">
                            <p class="text-2xl font-bold text-green-600"><?php echo e($stats['available_copies']); ?></p>
                            <p class="text-sm text-gray-600">Available</p>
                        </div>
                        <div class="text-center p-4 bg-orange-50 rounded-lg">
                            <p class="text-2xl font-bold text-orange-600"><?php echo e($stats['borrowed_books']); ?></p>
