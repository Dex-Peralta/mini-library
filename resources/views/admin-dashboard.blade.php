                    ...
                    <div class="p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $stats['authors'] }}</p>
                            </div>
                    ...
                    <div class="p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $stats['books'] }}</p>
                    ...
                    <div class="p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $stats['active_borrows'] }}</p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const inventoryChart = new Chart(inventoryCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [{{ $stats['available_copies'] }}, {{ $stats['borrowed_items'] }}, {{ $stats['reserved_items'] }}],
                        backgroundColor: [
                            'rgba(34, 197, 94, 0.8)',
                            'rgba(249, 115, 22, 0.8)',
                            'rgba(139, 92, 246, 0.8)'
            ...
            const borrowChart = new Chart(borrowCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Count',
                        data: [{{ $stats['active_borrows'] }}, {{ $stats['reserved_borrows'] }}, {{ $stats['overdue_items'] }}],
                        backgroundColor: [
                            'rgba(99, 102, 241, 0.8)',
                            'rgba(139, 92, 246, 0.8)',
                            'rgba(239, 68, 68, 0.8)'
