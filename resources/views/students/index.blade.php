<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('students.create') }}" class="bg-gray-900 hover:bg-gray-700 text-white px-4 py-2 rounded-md">
                Add New Student
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('students.index') }}" class="mb-6">
                        <div class="flex flex-col sm:flex-row gap-3 sm:items-center">
                            <input
                                ...
                                placeholder="Search by name, student number, college, course, email, or phone"
                            ...
                            <div class="flex gap-2">
                                ...
                                @if(request('search'))
                                    <a href="{{ route('students.index') }}" class="border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-md text-sm">Clear</a>
                                @endif
                            </div>
                        </div>
                    </form>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('students.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-900 hover:bg-gray-700">
                                    Add New Student
                                </a>
                            </div>
                        </div>
